...
//adjustable Masternode collateral call, currently 5000 DCOIN = $5,000 USD* subject to change+/- higher collateral/lower collateral
...
public:
    ...
    {
        // DCOIN: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // DCOIN: block signature - signed by one of the coin base txout[N]'s owner
